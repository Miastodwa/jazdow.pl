...
#oj-footer
	.inner-section
		...
		.social
			a.social-icon(v-for="item in $site.themeConfig.social", :href="item.href", :title="item.type", target="_blank", rel="noopener", v-html="socialChar(item.type)")
		.links
...
const xIcon = '<svg viewBox="0 0 24 24" fill="currentColor" width="1em" height="1em" style="vertical-align:middle"><path d="M18.244 2.25h3.308l-7.227 8.26 8.502 11.24H16.17l-4.714-6.231-5.401 6.231H2.747l7.73-8.835L1.254 2.25H8.08l4.259 5.622zm-1.161 17.52h1.833L7.084 4.126H5.117z"/></svg>'
const socialChars = { facebook: 'b', instagram: 'd', youtube: 'p', linkedin: 'o', x: xIcon }
